...
// capability, not a layout primitive — see README.md. Adding a new
// entry here is a real product decision (xyz-picker/xyz-uploader/
...
// low-level layout primitive — see README.md. Only what this version
// actually needs (title/description/widgets) — no layout, spacing, or
// visibility yet; those are real future fields on this same shape, not
// a reason to invent a separate concept now.
...
// Version 1's own cardinality restriction, layered on top of the
// general schema above rather than baked into it. Relaxing this later
// (more blocks, more widgets per block) never requires touching
// PageSpecSchema/BlockSpecSchema/WidgetSpecSchema themselves, only this
// refinement.
