...
This repo's own copy of the file never sets `action` statically — in that
state, its Submit button is disabled and it shows "Not connected
...
`library/widgets/xyz-waitlist` and `library/widgets/xyz-reactions` share. Set them
